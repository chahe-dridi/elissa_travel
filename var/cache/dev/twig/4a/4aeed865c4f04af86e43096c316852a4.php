...
class __TwigTemplate_82dd7b733c572c1d5492f15cf75af548 extends Template
{
    ...
    <main id=\"main\" class=\"main\">
                            ...
                            <table class=\"table\">
                                ...
                                <tr>
                                    <td>
                                        ";
        // line 84
        if ((twig_length_filter($this->env, (isset($context["listS"]) || array_key_exists("listS", $context) ? $context["listS"] : (function () { throw new RuntimeError('Variable "listS" does not exist.', 84, $this->source); })())) == 0)) {
            // line 85
            echo "
        ...
        // line 95
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["listS"]) || array_key_exists("listS", $context) ? $context["listS"] : (function () { throw new RuntimeError('Variable "listS" does not exist.', 95, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
            ...
            echo "
                                    ...
                                    <tr>
                                        ...
                                        <td>";
            // line 101
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "NomEvent", [], "any", false, false, false, 101), "html", null, true);
            echo "</td>
                                      <td>";
            // line 102
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "AdresseEvent", [], "any", false, false, false, 102), "html", null, true);
            echo "</td>
                                      <td>";
            // line 103
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "nbrticketsdispo", [], "any", false, false, false, 103), "html", null, true);
            echo "</td>
                                    <td>";
            // line 104
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "datedebutEvent", [], "any", false, false, false, 104), "Y-m-d H:i:s"), "html", null, true);
            echo "</td>
                                     <td>";
            // line 105
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "datefinevent", [], "any", false, false, false, 105), "Y-m-d H:i:s"), "html", null, true);
            echo "</td>

                                      <td>";
            // line 107
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["p"], "prixentre", [], "any", false, false, false, 107), "html", null, true);
            echo "</td>
                                      <td><img  style=\"width: 75px; height: 55px; padding: 5px;\" src=\"";
            // line 108
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/" . twig_get_attribute($this->env, $this->source, $context["p"], "imageevent", [], "any", false, false, false, 108))), "html", null, true);
            echo "\"/></td>

                                      <td>";
            // line 110
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["p"], "TypeEvenement", [], "any", false, false, false, 110), "nomType", [], "any", false, false, false, 110), "html", null, true);
            echo "</td>
                                     ...
                                     <td>
                                        <a href=\"";
            // line 116
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("modifierEvenement", ["id" => twig_get_attribute($this->env, $this->source, $context["p"], "id", [], "any", false, false, false, 116)]), "html", null, true);
            ...
            // line 122
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("suppressionEvent", ["id" => twig_get_attribute($this->env, $this->source, $context["p"], "id", [], "any", false, false, false, 122)]), "html", null, true);
...
";
    ...
    {
        return array (  296 => 131,  281 => 122,  272 => 116,  263 => 110,  258 => 108,  254 => 107,  249 => 105,  245 => 104,  241 => 103,  237 => 102,  233 => 101,  226 => 96,  222 => 95,  214 => 89,  208 => 85,  206 => 84,  174 => 55,  167 => 51,  160 => 47,  153 => 43,  148 => 40,  138 => 36,  135 => 35,  131 => 34,  127 => 32,  117 => 28,  114 => 27,  110 => 26,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
                        ...
                        <div class=\"card-body\">
                            ...
                            <div class=\"d-flex justify-content-between align-items-center mb-3\">
                                ...
                                <a href=\"{{ path('api_event_stats_by_type') }}\" class=\"btn btn-outline-primary\">
                                 ...
                                 <a href=\"{{ path('app_type_evenement') }}\" class=\"btn btn-outline-primary\">
                                   Type 
                                </a>

                                 <a href=\"{{ path('app_reservationEvent') }}\" class=\"btn btn-outline-primary\">
                                   reservation 
                                </a>
                                <!-- End Button for statistics -->
...
{% endblock %}
", "event/afficherEvent.html.twig", "C:\\Users\\msi\\Desktop\\gestion_user - oumayma\\templates\\event\\afficherEvent.html.twig");
    }
}
