...
class __TwigTemplate_0fd1e39e7d653733630c3598be28819c extends Template
{
    private $source;
    private $macros = [];
    ...
    {% if segment in app.request.attributes.get('_route') %}
        active
    {% endif %}
{% endmacro %}", "partials/_macro.html.twig", "C:\\Users\\msi\\Desktop\\User-Crud-Symfony5-master\\templates\\partials\\_macro.html.twig");
    }
}
