...
";
    ...
    <div class=\"card shadow my-4\">
        ...
        echo "
            ";
        // line 27
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 27, $this->source); })()), "searchTerm", [], "any", false, false, false, 27), 'row', ["attr" => ["class" => "form-control"]]);
        echo "
            </br>
        ...
        <a href=\"";
        // line 34
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_download");
        echo "\" class=\"btn btn-primary\">Download blocked users</a>
            <a href=\"";
        // line 35
    ...
    ";
        // line 38
        if ( !twig_test_empty((isset($context["users"]) || array_key_exists("users", $context) ? $context["users"] : (function () { throw new RuntimeError('Variable "users" does not exist.', 38, $this->source); })()))) {
            // line 39
            echo "                </br>
        <h2>Search Results</h2>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
                ...
                echo "                        <tr>
                            <td>";
                // line 56
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "firstName", [], "any", false, false, false, 56), "html", null, true);
                echo "</td>
                            <td>";
                // line 57
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "lastName", [], "any", false, false, false, 57), "html", null, true);
                echo "</td>
                            <td>";
                // line 58
                ...
                echo "</td>
                            <td>";
                // line 60
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "roleTitle", [], "any", false, false, false, 60), "html", null, true);
                echo "</td>
                            <td>";
                // line 61
                echo ((twig_get_attribute($this->env, $this->source, $context["user"], "isVerified", [], "any", false, false, false, 61)) ? ("Enabled") : ("Disabled"));
                echo "
                            <td>
                                <a href=\"";
                // line 63
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_user_show", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 63)]), "html", null, true);
                ...
                // line 67
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("Status", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 67)]), "html", null, true);
                echo "\">
                            <button type=\"submit\" class =\"btn btn-info\">Toggle Status</button>
                                ...
                                ";
                // line 71
                if ((twig_get_attribute($this->env, $this->source, $context["user"], "roleTitle", [], "any", false, false, false, 71) == "Utilisateur")) {
                    // line 72
                    echo "                                    <a href=\"";
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_user_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 72)]), "html", null, true);
                    echo "\" class=\"btn btn-primary\">
                                       Edit
                                    </a>
                                    <a href=\"";
                    // line 75
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_user_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 75)]), "html", null, true);
...
";
    ...
    {
        return array (  270 => 85,  265 => 82,  257 => 79,  250 => 75,  243 => 72,  241 => 71,  234 => 67,  227 => 63,  222 => 61,  218 => 60,  214 => 59,  210 => 58,  206 => 57,  202 => 56,  199 => 55,  195 => 54,  178 => 39,  176 => 38,  170 => 35,  166 => 34,  159 => 30,  153 => 27,  149 => 26,  137 => 17,  132 => 14,  122 => 13,  109 => 8,  99 => 7,  80 => 5,  61 => 3,  38 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"card shadow my-4\">
        ...
        <a href=\"{{path('app_download')}}\" class=\"btn btn-primary\">Download blocked users</a>
            <a href=\"{{ path('app_pdf') }}\" class=\"btn btn-primary\">Download PDF</a>
            <div class=\"table-responsive\">
