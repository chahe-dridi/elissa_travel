 ...
 */
class getTypeEvenementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeEvenementRepository' shared autowired service.
     *
     * @return \App\Repository\TypeEvenementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeEvenementRepository.php';

        return $container->privates['App\\Repository\\TypeEvenementRepository'] = new \App\Repository\TypeEvenementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
