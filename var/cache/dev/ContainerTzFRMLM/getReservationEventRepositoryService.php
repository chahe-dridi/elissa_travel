 ...
 */
class getReservationEventRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationEventRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationEventRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationEventRepository.php';

        return $container->privates['App\\Repository\\ReservationEventRepository'] = new \App\Repository\ReservationEventRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
