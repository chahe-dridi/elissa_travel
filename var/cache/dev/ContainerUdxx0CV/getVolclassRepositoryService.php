 ...
 */
class getVolclassRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VolclassRepository' shared autowired service.
     *
     * @return \App\Repository\VolclassRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VolclassRepository.php';

        return $container->privates['App\\Repository\\VolclassRepository'] = new \App\Repository\VolclassRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
