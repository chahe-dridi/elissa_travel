...
return [
    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .'|/modifier(?'
                    .'|Event/([^/]++)(*:211)'
                    .'|reservationEvent/([^/]++)(*:244)'
                    .'|TypeEvenement/([^/]++)(*:274)'
                .')'
                .'|/suppression(?'
                    .'|Event/([^/]++)(*:312)'
                    .'|reservationEvent/([^/]++)(*:345)'
                    .'|Typeevent/([^/]++)(*:371)'
                .')'
                .'|/generate\\-pdf/([^/]++)(*:403)'
                .'|/rese(?'
    ...
    [ // $dynamicRoutes
        ...
        211 => [[['_route' => 'modifierEvenement', '_controller' => 'App\\Controller\\EventController::modifierArticle'], ['id'], null, null, false, true, null]],
        244 => [[['_route' => 'modifierreservationEvent', '_controller' => 'App\\Controller\\ReservationEventController::modifierreservationEvent'], ['id'], null, null, false, true, null]],
        274 => [[['_route' => 'modifierTypeEvenement', '_controller' => 'App\\Controller\\TypeEvenementController::modifierTypeEvenement'], ['id'], null, null, false, true, null]],
        312 => [[['_route' => 'suppressionEvent', '_controller' => 'App\\Controller\\EventController::suppressionEvent'], ['id'], null, null, false, true, null]],
        345 => [[['_route' => 'deletereservationEvent', '_controller' => 'App\\Controller\\ReservationEventController::suppressionreservationEvent'], ['id'], null, null, false, true, null]],
        371 => [[['_route' => 'suppressionTypeEvent', '_controller' => 'App\\Controller\\TypeEvenementController::suppressionTypeEvent'], ['id'], null, null, false, true, null]],
        403 => [[['_route' => 'generate_pdf', '_controller' => 'App\\Controller\\ReservationEventController::generatePDF'], ['id'], null, null, false, true, null]],
        451 => [[['_route' => 'app_reservation_vol_admin_show', '_controller' => 'App\\Controller\\ReservationVolAdminController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        464 => [[['_route' => 'app_reservation_vol_admin_edit', '_controller' => 'App\\Controller\\ReservationVolAdminController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        472 => [[['_route' => 'app_reservation_vol_admin_delete', '_controller' => 'App\\Controller\\ReservationVolAdminController::delete'], ['id'], ['POST' => 0], null, false, true, null]],
        501 => [[['_route' => 'app_reservationvol_edit', '_controller' => 'App\\Controller\\ReservationvolController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        509 => [[['_route' => 'app_reservationvol_delete', '_controller' => 'App\\Controller\\ReservationvolController::delete'], ['id'], ['POST' => 0], null, false, true, null]],
        529 => [[['_route' => 'app_reset_password', '_controller' => 'App\\Controller\\UserController::resetpassword'], ['token'], null, null, false, true, null]],
        557 => [[['_route' => 'app_vol_show', '_controller' => 'App\\Controller\\VolController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        570 => [[['_route' => 'app_vol_edit', '_controller' => 'App\\Controller\\VolController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        578 => [[['_route' => 'app_vol_delete', '_controller' => 'App\\Controller\\VolController::delete'], ['id'], ['POST' => 0], null, false, true, null]],
        604 => [[['_route' => 'app_volclass_show', '_controller' => 'App\\Controller\\VolclassController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        617 => [[['_route' => 'app_volclass_edit', '_controller' => 'App\\Controller\\VolclassController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        625 => [[['_route' => 'app_volclass_delete', '_controller' => 'App\\Controller\\VolclassController::delete'], ['id'], ['POST' => 0], null, false, true, null]],
        666 => [[['_route' => '_preview_error', '_controller' => 'error_controller::preview', '_format' => 'html'], ['code', '_format'], null, null, false, true, null]],
        686 => [[['_route' => '_wdt', '_controller' => 'web_profiler.controller.profiler::toolbarAction'], ['token'], null, null, false, true, null]],
