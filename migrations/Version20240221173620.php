 ...
 */
final class Version20240221173620 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hotel (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, nom_hotel VARCHAR(255) NOT NULL, lieu VARCHAR(255) NOT NULL, tel_hotel VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, disc_hotel VARCHAR(255) NOT NULL, etat_hotel VARCHAR(255) NOT NULL, nb_chambre INT NOT NULL, INDEX IDX_3535ED9A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
