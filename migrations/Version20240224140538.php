 ...
 */
final class Version20240224140538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation_hotel (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, hotel_id INT DEFAULT NULL, payment_id INT DEFAULT NULL, prix_tt DOUBLE PRECISION NOT NULL, date_arrive DATE NOT NULL, date_depart DATE NOT NULL, email VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, pre_nom VARCHAR(255) NOT NULL, distination VARCHAR(255) NOT NULL, chambr_e VARCHAR(255) NOT NULL, INDEX IDX_402C8E7EA76ED395 (user_id), INDEX IDX_402C8E7E3243BB18 (hotel_id), INDEX IDX_402C8E7E4C3A3BB (payment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
