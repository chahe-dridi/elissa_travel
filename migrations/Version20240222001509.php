 ...
 */
final class Version20240222001509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation_hotel (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, hotel_id INT DEFAULT NULL, prix_tt DOUBLE PRECISION NOT NULL, INDEX IDX_402C8E7EA76ED395 (user_id), INDEX IDX_402C8E7E3243BB18 (hotel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservation_voyage (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, voyage_id INT DEFAULT NULL, numberticket INT NOT NULL, INDEX IDX_776CC0CEA76ED395 (user_id), INDEX IDX_776CC0CE68C9E5AF (voyage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vol (id INT AUTO_INCREMENT NOT NULL, airport_depart_id INT DEFAULT NULL, airport_arrive_id INT DEFAULT NULL, volclass_id INT DEFAULT NULL, user_id INT DEFAULT NULL, compagnie_aerienne VARCHAR(255) NOT NULL, heure_depart DATETIME NOT NULL, heure_arrive DATETIME NOT NULL, escale TINYINT(1) NOT NULL, disponible TINYINT(1) NOT NULL, INDEX IDX_95C97EB323E3080 (airport_depart_id), INDEX IDX_95C97EB683E4883 (airport_arrive_id), INDEX IDX_95C97EB6889D068 (volclass_id), INDEX IDX_95C97EBA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE voyage (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, mois DATE NOT NULL, année DATE NOT NULL, villedepart VARCHAR(255) NOT NULL, INDEX IDX_3F9D8955A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
